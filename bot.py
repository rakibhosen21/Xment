...
async def comment_command(interaction: discord.Interaction, x_post_url: str):
    ...
    try:
        ...
        # Build elegant Discord Embed Response
        embed = discord.Embed(
...
if __name__ == "__main__":
    if not DISCORD_TOKEN:
        logger.critical("DISCORD_TOKEN is missing! Provide token in .env prior to starting!")
    else:
        logger.info("Initializing bot connection sequence...")
